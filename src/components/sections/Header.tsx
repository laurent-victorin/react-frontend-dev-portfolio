    ...
    <>
      <header className="h-[650px] w-[100%] bg-yellow dark:bg-[#494949]">
        ...
        <div className="flex h-full flex-col items-center justify-center gap-5">
          ...
          <img
            src="https://res.cloudinary.com/dy5kblr32/image/upload/v1721116944/samples/dev_SF_006_rv5xlr.png"
            alt=""
      ...
      <div className="flex justify-center gap-5 bg-yellow pb-2.5 pt-6 dark:bg-[#494949]">
        <Icon
          className={clsx(
